...
- [The New and Improved _beatblock guide_](#the-new-and-improved-beatblock-guide)
  - [Table of Contents](#table-of-contents)
  - [Getting Started](#getting-started)
    - [Importing Songs](#importing-songs)
    - [GETTING THE OFFSET](#getting-the-offset)
      - [if you don't do this I will personally find and attack you (that's a joke)](#if-you-dont-do-this-i-will-personally-find-and-attack-you-thats-a-joke)
    - [Issues with Importing Songs](#issues-with-importing-songs)
      - [Make sure that you have an OGG vorbis file](#make-sure-that-you-have-an-ogg-vorbis-file)
      - [Make sure you have file name extensions enabled](#make-sure-you-have-file-name-extensions-enabled)
